...
test("rescue command absorbs continue semantics", () => {
  ...
  assert.match(rescue, /If the user did not pass `--model`, append `--model review-fast`/i);
  ...
  assert.match(agent, /If the user did not pass `--model`, append `--model review-fast`/i);
  ...
  assert.match(runtimeSkill, /If the user did not pass `--model`, append `--model review-fast`/i);
...
test("setup command can offer Codex install and still points users to codex login", () => {
  ...
  assert.match(
    setup,
    /argument-hint:\s*'\[--enable-review-gate\|--enable-review-gate-spark\|--disable-review-gate\]'/
  );
  assert.match(setup, /--enable-review-gate-spark/);
